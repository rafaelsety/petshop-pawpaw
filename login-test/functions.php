...
function upload() {
    ...
    move_uploaded_file($tmpName, 'latimg/' . $namaFileBaru);
...
function cari($keyword) {
    $query = "SELECT * FROM member WHERE kode_member LIKE '%$keyword%' OR nama LIKE '%$keyword%'";
    return query($query);
}
