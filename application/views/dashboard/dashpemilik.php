...
<div class="container-fluid">
    ...
    <div class="row no-gutter align-items-center vh-100">
        <div class="col-10 col-md-7 col-lg-7 mx-auto">
            <div class="card-deck">
                <div class="card mr-5" style="background:red;color:white;">
                ...
                <div class="card mr-5" style="background:yellow;color:white;">
                ...
                <div class="card mr-5" style="background:green;color:white;">
                    <a href="<?= base_url('manajemen'); ?>">
                        <div class="card-body">
                            ...
                            <h5 class="card-title text-white">manajemen</h5>
                        </div>
                </div>
            </div>
        </div>
